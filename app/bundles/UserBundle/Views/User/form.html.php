            ...
            <div class="form-group mb-0">
                <div class="row">
                    <?php foreach ($fields as $name => $field): ?>
                        <div class="col-sm-6<?php echo (count($form[$field['alias']]->vars['errors'])) ? ' has-error' : ''; ?>">
                            <label class="control-label mb-xs"><?php echo $view['form']->label($form[$field['alias']]); ?></label>
                            <?php echo $view['form']->widget($form[$field['alias']], ['attr' => ['placeholder' => $form[$field['alias']]->vars['label']]]); ?>
                            <?php echo $view['form']->errors($form[$field['alias']]); ?>
                        </div>
                    <?php endforeach; ?>
                </div>
            </div>
