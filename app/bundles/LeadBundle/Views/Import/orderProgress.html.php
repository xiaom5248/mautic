...
$view['slots']->set('mauticContent', 'orderImport');
$view['slots']->set('headerTitle', $view['translator']->trans('mautic.lead.import.orders'));

$percent = ($progress[1]) ? ceil(($progress[0] / $progress[1]) * 100) : 100;
$id      = ($complete) ? 'orderImportProgressComplete' : 'orderImportProgress';
